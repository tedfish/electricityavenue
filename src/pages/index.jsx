...
const Index = () => (
  <Layout>
    ...
    <View title="Firebase Authentication Starter">
      <p>
      👋 **sss*This is a simple demo of creating dynamic pages with Gatsby that require <b>user authentication</b> and using <b>Firebase</b> as authentication provider. 
      </p>  
      <br/>
      <p>
